<template>
    <Tooltip content="换肤" placement="left">
...
export default {
    ...
    methods: {
        setTheme (themeFile) {
            ...
            let stylePath = '';
            if (ENV.NAME.indexOf('dev') > -1) {
                stylePath = './src/views-core/main-components/theme-switch/theme/';
            } else {
                stylePath = 'dist/';
            }
            if (mainTheme !== 'b') {
    ...
    created () {
        let path = '';
        if (ENV.NAME.indexOf('dev') > -1) {
            path = './src/views-core/main-components/theme-switch/theme/';
        } else {
            path = 'dist/';
        }
